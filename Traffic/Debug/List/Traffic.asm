...
_0x3:
; 0000 000E     {
; 0000 000F      if (PINA.7==1)
	SBIS 0x19,7
	RJMP _0x6
; 0000 0010      {
; 0000 0011       PORTC=0x01;
	RCALL SUBOPT_0x1
; 0000 0012       PORTD=0x04;
; 0000 0013       delay_ms(300);
; 0000 0014 
; 0000 0015       PORTC=0x02;
	LDI  R30,LOW(2)
	RCALL SUBOPT_0x2
; 0000 0016       PORTD=0x01;
; 0000 0017       delay_ms(300);
; 0000 0018 
; 0000 0019       PORTC=0x04;
	LDI  R30,LOW(4)
	RCALL SUBOPT_0x2
; 0000 001A       PORTD=0x01;
; 0000 001B       delay_ms(300);
; 0000 001C 
; 0000 001D       PORTC=0x01;
	LDI  R30,LOW(1)
	OUT  0x15,R30
; 0000 001E       PORTD=0x02;
	LDI  R30,LOW(2)
	OUT  0x12,R30
; 0000 001F       delay_ms(300);
	...
	RCALL _delay_ms
; 0000 0020 
; 0000 0021       PORTC=0x01;
	RCALL SUBOPT_0x1
; 0000 0022       PORTD=0x04;
