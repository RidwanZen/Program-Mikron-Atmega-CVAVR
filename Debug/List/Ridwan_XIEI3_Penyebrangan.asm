...
_variasi2:
; .FSTART _variasi2
; 0000 001E     PORTC=0x0C;
	LDI  R30,LOW(12)
	RCALL SUBOPT_0x0
; 0000 001F     delay_ms(100);
; 0000 0020 
; 0000 0021     PORTC=0x12;
	LDI  R30,LOW(18)
	RCALL SUBOPT_0x0
; 0000 0022     delay_ms(100);
; 0000 0023 
; 0000 0024     PORTC=0x21;
	LDI  R30,LOW(33)
	OUT  0x15,R30
; 0000 0025     delay_ms(800);
	LDI  R26,LOW(800)
	LDI  R27,HIGH(800)
	RCALL _delay_ms
; 0000 0026 
; 0000 0027     PORTC=0x12;
	LDI  R30,LOW(18)
	OUT  0x15,R30
